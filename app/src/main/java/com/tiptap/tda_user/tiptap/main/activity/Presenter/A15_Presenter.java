...
public class A15_Presenter
        implements MVP_A15.ProvidedPresenterOps, MVP_A15.RequiredPresenterOps {

    private WeakReference<MVP_A15.RequiredViewOps> mView;
    private MVP_A15.ProvidedModelOps mModel;

    public A15_Presenter(MVP_A15.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A15.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A15.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A15.ProvidedModelOps model) {
        mModel = model;
    }
