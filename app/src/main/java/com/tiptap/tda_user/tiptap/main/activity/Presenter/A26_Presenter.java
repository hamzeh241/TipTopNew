...
public class A26_Presenter implements MVP_A26.ProvidedPresenterOps, MVP_A26.RequiredPresenterOps {

    private WeakReference<MVP_A26.RequiredViewOps> mView;
    private MVP_A26.ProvidedModelOps mModel;

    public A26_Presenter(MVP_A26.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A26.RequiredViewOps getView() throws NullPointerException {
        if (mView != null)
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A26.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A26.ProvidedModelOps model) {
        mModel = model;
    }
