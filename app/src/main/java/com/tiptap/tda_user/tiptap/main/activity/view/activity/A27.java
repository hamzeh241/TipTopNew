...
public class A27 extends BaseActivity implements MVP_Main.RequiredViewOps,OnClickListener{
    ...
    public void update_server(int idL) {
        try {
            ...
            new Post_UpdateUser(getApplicationContext(), A27.this, haveNetworkConnection(), UserName, idL).post();
