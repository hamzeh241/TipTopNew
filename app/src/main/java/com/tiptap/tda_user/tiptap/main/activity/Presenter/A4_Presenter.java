...
public class A4_Presenter
        implements MVP_A4.ProvidedPresenterOps, MVP_A4.RequiredPresenterOps {

    private WeakReference<MVP_A4.RequiredViewOps> mView;
    private MVP_A4.ProvidedModelOps mModel;

    public A4_Presenter(MVP_A4.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A4.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A4.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A4.ProvidedModelOps model) {
        mModel = model;
    }
