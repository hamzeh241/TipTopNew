...
public class A29_Presenter
        implements MVP_A29.ProvidedPresenterOps, MVP_A29.RequiredPresenterOps {

    private WeakReference<MVP_A29.RequiredViewOps> mView;
    private MVP_A29.ProvidedModelOps mModel;

    public A29_Presenter(MVP_A29.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A29.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A29.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A29.ProvidedModelOps model) {
        mModel = model;
    }
