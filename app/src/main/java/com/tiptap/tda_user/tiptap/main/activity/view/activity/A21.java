...
public class A21 extends BaseActivity
        implements MVP_Main.RequiredViewOps,View.OnClickListener {

    private static final String TAG = A21.class.getSimpleName();
    private final StateMaintainer mStateMaintainer = new StateMaintainer( getFragmentManager(), A21.class.getName());
...
//        title2detailactivity = tbActivityDetailList.get(0).getTitle2().toString();
    ...
    private void after_setup() {
        ...
        switch (lang_id) {
            // فارسی
            case 1:
                t2.setText(R.string.A21_FA);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // کردی
            case 2:
                t2.setText(R.string.A21_KU);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // ترکی آذری
            case 3:
                t2.setText(R.string.A21_TA);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // چینی
            case 4:
                t2.setText(R.string.A21_CH);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
        }
        ...
        // each row - title1
            ...
            if(total == 1){
                ...
                // only text without ...
                    ...
                    add_len = add_len + list_w[0].length();
                    if(add_len > 30){
                        l2.addView(t[id_t]);
                    }else{
                        l1.addView(t[id_t]);
                ...
                for(int xi=0 ; xi<total ; xi++){
                    ...
                    if(xi == 0){
                        ...
                        if(start == 0){
                            ...
                            t[id_t].setTextSize(16);
                            add_len = add_len + list_w[id_w].length();
                            if(add_len > 30){
                                l2.addView(t[id_t]);
                            }else{
                                l1.addView(t[id_t]);
                        ...
                        if(Act_Status.equals("first")){
                            ...
                            if(activitynumber == max) {
                                ...
                                if (number == 0) {
                                    ...
                                    A21.this.finish();
                                    startActivity(new Intent(A21.this, End.class));
                                }
    ...
    private void setupComponent(){
        ...
        SampleApp.get(this)
                .getAppComponent()
                .getA21Component(new Main_Module(this))
                .inject(this);
    }
    ...
    public void update_server(int idL) {
        try {
            ...
            new Post_UpdateUser(getApplicationContext(), A21.this, haveNetworkConnection(), UserName, idL).post();
