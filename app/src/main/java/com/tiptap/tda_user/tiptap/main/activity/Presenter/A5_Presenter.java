...
public class A5_Presenter implements MVP_A5.ProvidedPresenterOps, MVP_A5.RequiredPresenterOps {

    private WeakReference<MVP_A5.RequiredViewOps> mView;
    private MVP_A5.ProvidedModelOps mModel;

    public A5_Presenter(MVP_A5.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A5.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A5.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A5.ProvidedModelOps model) {
        mModel = model;
    }
