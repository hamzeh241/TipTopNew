...
public class A27_Presenter
        implements MVP_A27.ProvidedPresenterOps, MVP_A27.RequiredPresenterOps {

    private WeakReference<MVP_A27.RequiredViewOps> mView;
    private MVP_A27.ProvidedModelOps mModel;

    public A27_Presenter(MVP_A27.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A27.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A27.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A27.ProvidedModelOps model) {
        mModel = model;
    }
