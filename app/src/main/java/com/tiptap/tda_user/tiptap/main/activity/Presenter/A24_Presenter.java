...
public class A24_Presenter
        implements MVP_A24.ProvidedPresenterOps, MVP_A24.RequiredPresenterOps {

    private WeakReference<MVP_A24.RequiredViewOps> mView;
    private MVP_A24.ProvidedModelOps mModel;

    public A24_Presenter(MVP_A24.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A24.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A24.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A24.ProvidedModelOps model) {
        mModel = model;
    }
