...
public class A35_Presenter implements MVP_A35.ProvidedPresenterOps, MVP_A35.RequiredPresenterOps {

    private WeakReference<MVP_A35.RequiredViewOps> mView;
    private MVP_A35.ProvidedModelOps mModel;

    public A35_Presenter(MVP_A35.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A35.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A35.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A35.ProvidedModelOps model) {
        mModel = model;
    }
