...
public class A6_Model implements MVP_A6.ProvidedModelOps {

    private MVP_A6.RequiredPresenterOps mPresenter;
    DBAdapter dbAdapter;
    Context context;
    ...
    public A6_Model(MVP_A6.RequiredPresenterOps presenter, Context _conContext) {
