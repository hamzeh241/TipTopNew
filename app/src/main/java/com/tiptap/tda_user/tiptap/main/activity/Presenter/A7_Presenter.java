...
public class A7_Presenter
        implements MVP_A7.ProvidedPresenterOps, MVP_A7.RequiredPresenterOps {

    private WeakReference<MVP_A7.RequiredViewOps> mView;
    private MVP_A7.ProvidedModelOps mModel;

    public A7_Presenter(MVP_A7.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A7.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A7.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A7.ProvidedModelOps model) {
        mModel = model;
    }
