...
//String aa=answer;
    ...
    private void after_setup(){
        ...
        switch (lang_id){
            // فارسی
            case 1:
                t2.setText(R.string.A10_FA);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // کردی
            case 2:
                t2.setText(R.string.A10_KU);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // ترکی آذری
            case 3:
                t2.setText(R.string.A10_TA);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // چینی
            case 4:
                t2.setText(R.string.A10_CH);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
        }
    ...
    private void setupComponent(){
        ...
        SampleApp.get(this)
                .getAppComponent()
                .getA10Component(new Main_Module(this))
                .inject(this);
    }
