...
public class A9_Presenter
        implements MVP_A9.ProvidedPresenterOps, MVP_A9.RequiredPresenterOps {

    private WeakReference<MVP_A9.RequiredViewOps> mView;
    private MVP_A9.ProvidedModelOps mModel;

    public A9_Presenter(MVP_A9.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A9.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A9.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A9.ProvidedModelOps model) {
        mModel = model;
    }
