...
public class A45_Presenter
        implements MVP_A45.ProvidedPresenterOps, MVP_A45.RequiredPresenterOps {

    private WeakReference<MVP_A45.RequiredViewOps> mView;
    private MVP_A45.ProvidedModelOps mModel;

    public A45_Presenter(MVP_A45.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A45.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A45.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A45.ProvidedModelOps model) {
        mModel = model;
    }
