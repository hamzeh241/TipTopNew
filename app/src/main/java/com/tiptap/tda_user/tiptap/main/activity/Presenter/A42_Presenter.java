...
public class A42_Presenter
        implements MVP_A42.ProvidedPresenterOps, MVP_A42.RequiredPresenterOps {

    private WeakReference<MVP_A42.RequiredViewOps> mView;
    private MVP_A42.ProvidedModelOps mModel;

    public A42_Presenter(MVP_A42.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A42.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A42.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A42.ProvidedModelOps model) {
        mModel = model;
    }
