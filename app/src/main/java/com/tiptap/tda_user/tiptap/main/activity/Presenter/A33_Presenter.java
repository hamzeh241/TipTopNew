...
public class A33_Presenter
        implements MVP_A33.ProvidedPresenterOps, MVP_A33.RequiredPresenterOps {

    private WeakReference<MVP_A33.RequiredViewOps> mView;
    private MVP_A33.ProvidedModelOps mModel;

    public A33_Presenter(MVP_A33.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A33.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A33.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A33.ProvidedModelOps model) {
        mModel = model;
    }
