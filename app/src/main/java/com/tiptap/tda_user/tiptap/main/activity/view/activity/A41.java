...
public class A41 extends BaseActivity
    ...
    private static final String TAG = A41.class.getSimpleName();
    private final StateMaintainer mStateMaintainer = new StateMaintainer( getFragmentManager(), A41.class.getName());

    @Inject
    public MVP_Main.ProvidedPresenterOps mPresenter;
    int back_pressed = 0;

    TextView t1[],t2[],ti1,ti2,t;
    String w1[] , w2[];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title1 = tbActivityDetailList.get(0).getTitle1();
        title1 = title1.trim();
        title2 = tbActivityDetailList.get(0).getTitle2();
        title2 = title2.trim();
    ...
    private void after_setup(){
        ...
        switch (lang_id){
            // فارسی
            case 1:
                ti2.setText(R.string.A41_FA);
                ti2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // کردی
            case 2:
                ti2.setText(R.string.A41_KU);
                ti2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // ترکی آذری
            case 3:
                ti2.setText(R.string.A41_TA);
                ti2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // چینی
            case 4:
                ti2.setText(R.string.A41_CH);
                ti2.setTextColor(getResources().getColor(R.color.my_black));
                break;
        }
        ...
        t2 = new TextView[title1.split(" ").length];
        int count1 = 0;
        int count2 = 0;
        ...
        for(int i = 0; i < t1.length ; i++){
            ...
            final int finalI = i;
            t1[i].setOnClickListener(new OnClickListener() {
                @Override
        ...
        for(int i = 0; i < t2.length ; i++){
            ...
            final int finalI = i;
            t2[i].setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
                        ...
                        if(Act_Status.equals("first")){
                            ...
                            if(activitynumber == max) {
                                ...
                                if (number == 0) {
                                    ...
                                    startActivity(new Intent(A41.this, End.class));
                                }
    ...
    private void setupComponent(){
        ...
        SampleApp.get(this)
                .getAppComponent()
                .getA41Component(new Main_Module(this))
                .inject(this);
    }
    ...
    public void back(){
        if(back_pressed == 1){
            ...
            A41.this.finish();
            closeOtherMediaPlayer();
            startActivity(new Intent(A41.this, Lesson.class));
        }
    }
    ...
    public void update_server(int idL) {
        try {
            ...
            new Post_UpdateUser(getApplicationContext(), A41.this, haveNetworkConnection(), UserName, idL).post();
