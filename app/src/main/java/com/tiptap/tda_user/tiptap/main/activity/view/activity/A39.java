...
public class A39 extends AppCompatActivity
                 implements MVP_A39.RequiredViewOps {
    ...
    @Inject
    public MVP_A39.ProvidedPresenterOps mPresenter;
    ...
    private void initialize(){
        ...
        setupComponent();
        mStateMaintainer.put(A39_Presenter.class.getSimpleName(), mPresenter);
    }

    private void reinitialize() {
        Log.d(TAG, "reinitialize");
        mPresenter = mStateMaintainer.get(A39_Presenter.class.getSimpleName());
    ...
    private void setupComponent(){
        ...
        SampleApp.get(this)
                .getAppComponent()
                .getA39Component(new A39_Module(this))
                .inject(this);
    }
