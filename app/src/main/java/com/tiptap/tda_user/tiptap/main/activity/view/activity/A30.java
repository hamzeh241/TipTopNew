...
public class A30 extends BaseActivity
    ...
    @Inject
    public MVP_A30.ProvidedPresenterOps mPresenter;
    ...
    private void initialize(){
        ...
        setupComponent();
        mStateMaintainer.put(A30_Presenter.class.getSimpleName(), mPresenter);
    }

    private void reinitialize() {
        Log.d(TAG, "reinitialize");
        mPresenter = mStateMaintainer.get(A30_Presenter.class.getSimpleName());
