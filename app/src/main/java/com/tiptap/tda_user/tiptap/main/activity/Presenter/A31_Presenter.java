...
public class A31_Presenter
        implements MVP_A31.ProvidedPresenterOps, MVP_A31.RequiredPresenterOps {

    private WeakReference<MVP_A31.RequiredViewOps> mView;
    private MVP_A31.ProvidedModelOps mModel;

    public A31_Presenter(MVP_A31.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A31.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A31.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A31.ProvidedModelOps model) {
        mModel = model;
    }
