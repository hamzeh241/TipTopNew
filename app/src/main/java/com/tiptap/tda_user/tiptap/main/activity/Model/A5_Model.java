...
public class A5_Model
        implements MVP_A5.ProvidedModelOps {

    private MVP_A5.RequiredPresenterOps mPresenter;
    DBAdapter dbAdapter;
    Context context;
    ...
    public A5_Model(MVP_A5.RequiredPresenterOps presenter, Context _conContext) {
