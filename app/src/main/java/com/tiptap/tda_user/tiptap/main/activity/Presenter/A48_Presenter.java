...
public class A48_Presenter implements MVP_A48.ProvidedPresenterOps, MVP_A48.RequiredPresenterOps {

    private WeakReference<MVP_A48.RequiredViewOps> mView;
    private MVP_A48.ProvidedModelOps mModel;

    public A48_Presenter(MVP_A48.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A48.RequiredViewOps getView() throws NullPointerException {
        if (mView != null)
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A48.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A48.ProvidedModelOps model) {
        mModel = model;
    }
    ...
    @Override
    public int now_IdFunction(int lid) {
        return mModel.now_IdFunction(lid);
    }
