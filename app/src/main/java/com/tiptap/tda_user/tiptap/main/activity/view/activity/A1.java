...
public class A1 extends BaseActivity
                implements MVP_A1.RequiredViewOps,
    ...
    @Inject
    public MVP_A1.ProvidedPresenterOps mPresenter;
    ...
    private void initialize(){
        ...
        setupComponent();
        mStateMaintainer.put(A1_Presenter.class.getSimpleName(), mPresenter);
    }

    private void reinitialize() {
        Log.d(TAG, "reinitialize");
        mPresenter = mStateMaintainer.get(A1_Presenter.class.getSimpleName());
