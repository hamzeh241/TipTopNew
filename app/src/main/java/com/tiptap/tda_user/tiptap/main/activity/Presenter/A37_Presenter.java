...
public class A37_Presenter
        implements MVP_A37.ProvidedPresenterOps, MVP_A37.RequiredPresenterOps {

    private WeakReference<MVP_A37.RequiredViewOps> mView;
    private MVP_A37.ProvidedModelOps mModel;

    public A37_Presenter(MVP_A37.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A37.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A37.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A37.ProvidedModelOps model) {
        mModel = model;
    }
