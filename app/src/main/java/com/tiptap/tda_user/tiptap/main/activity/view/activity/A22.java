...
public class A22 extends BaseActivity
    ...
    private void after_setup() {
        ...
        switch (lang_id){
            // فارسی
            case 1:
                t2.setText(R.string.A22_FA);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // کردی
            case 2:
                t2.setText(R.string.A22_KU);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // ترکی آذری
            case 3:
                t2.setText(R.string.A22_TA);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // چینی
            case 4:
                t2.setText(R.string.A22_CH);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
        }
    ...
    public void back(){
        if(back_pressed == 1){
            ...
            A22.this.finish();
            closeOtherMediaPlayer();
            startActivity(new Intent(A22.this, Lesson.class));
        }
    }
    ...
    public void update_server(int idL) {
        try {
            ...
            new Post_UpdateUser(getApplicationContext(), A22.this, haveNetworkConnection(), UserName, idL).post();
