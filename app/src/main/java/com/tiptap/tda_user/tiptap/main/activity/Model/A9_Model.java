...
public class A9_Model
        implements MVP_A9.ProvidedModelOps {

    private MVP_A9.RequiredPresenterOps mPresenter;
    DBAdapter dbAdapter;
    Context context;
    ...
    public A9_Model(MVP_A9.RequiredPresenterOps presenter, Context _conContext) {
