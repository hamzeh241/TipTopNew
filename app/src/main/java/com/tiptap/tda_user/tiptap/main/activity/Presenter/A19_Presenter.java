...
public class A19_Presenter
        implements MVP_A19.ProvidedPresenterOps, MVP_A19.RequiredPresenterOps {

    private WeakReference<MVP_A19.RequiredViewOps> mView;
    private MVP_A19.ProvidedModelOps mModel;

    public A19_Presenter(MVP_A19.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A19.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A19.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A19.ProvidedModelOps model) {
        mModel = model;
    }
