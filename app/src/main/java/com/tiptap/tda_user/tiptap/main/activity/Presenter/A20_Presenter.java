...
public class A20_Presenter
        implements MVP_A20.ProvidedPresenterOps, MVP_A20.RequiredPresenterOps {

    private WeakReference<MVP_A20.RequiredViewOps> mView;
    private MVP_A20.ProvidedModelOps mModel;

    public A20_Presenter(MVP_A20.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A20.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A20.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A20.ProvidedModelOps model) {
        mModel = model;
    }
