...
public class A4 extends BaseActivity
    ...
    private void after_setup() {
        ...
        switch (lang_id){
            // فارسی
            case 1:
                t2.setText(R.string.A4_FA);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // کردی
            case 2:
                t2.setText(R.string.A4_KU);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // ترکی آذری
            case 3:
                t2.setText(R.string.A4_TA);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // چینی
            case 4:
                t2.setText(R.string.A4_CH);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
        }
        ...
        for(int i=0 ; i<count ; i++) {
            ...
            if(total == 1){
                ...
                if(w.equals("...")) {
                    ...
                    e[id_e].addTextChangedListener(new A4.CheckEdit());
    ...
    public void update_server(int idL) {
        try {
            ...
            new Post_UpdateUser(getApplicationContext(), A4.this, haveNetworkConnection(), UserName, idL).post();
