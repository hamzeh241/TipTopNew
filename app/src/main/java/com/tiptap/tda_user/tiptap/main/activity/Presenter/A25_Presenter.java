...
import com.tiptap.tda_user.tiptap.main.activity.Interface.MVP_A25;
...
public class A25_Presenter
        implements MVP_A25.ProvidedPresenterOps, MVP_A25.RequiredPresenterOps {

    private WeakReference<MVP_A25.RequiredViewOps> mView;
    private MVP_A25.ProvidedModelOps mModel;

    public A25_Presenter(MVP_A25.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A25.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A25.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A25.ProvidedModelOps model) {
        mModel = model;
    }
