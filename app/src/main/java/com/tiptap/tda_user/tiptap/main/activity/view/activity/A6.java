...
public class A6 extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(count==3){
            ...
            if(tbActivityDetailList.get(1).getTitle1() == null){
            ...
            if(tbActivityDetailList.get(2).getTitle1()==null){
            ...
            if(tbActivityDetailList.get(2).getIsAnswer().equals("1")){
                true_ans1=title3;
            }
        }
        ...
        if(count==6){
            ...
            if(tbActivityDetailList.get(4).getTitle1()==null){
                d.setVisibility(View.GONE);
            }else{
                title5=tbActivityDetailList.get(4).getTitle1().toString();
            }

            if(tbActivityDetailList.get(5).getTitle1()==null){
            ...
            if(tbActivityDetailList.get(4).getIsAnswer().equals("1")) {
                true_ans2=title5;
            }
            if(tbActivityDetailList.get(5).getIsAnswer().equals("1")){
                true_ans2=title6;
            }
        ...
        if(count==9){
            ...
            if(tbActivityDetailList.get(7).getTitle1()==null){
                f.setVisibility(View.GONE);
            }else{
                title8=tbActivityDetailList.get(7).getTitle1().toString();
            }

            if(tbActivityDetailList.get(8).getTitle1()==null){
            ...
            if(tbActivityDetailList.get(7).getIsAnswer().equals("1")) {
                true_ans3=title8;
            }
            if(tbActivityDetailList.get(8).getIsAnswer().equals("1")){
                true_ans3=title9;
            }
        }
                ...
                case "check":
                    ...
                    if(count == 3){
                            ...
                            if( my_ans1.equals("") || my_ans1.equals("null") ){
                                Toast.makeText(getApplicationContext(), "یکی از گزینه ها را برای سوال اول انتخاب کنید", Toast.LENGTH_SHORT).show();
                            }else{
                                have_answer++;
                            }
                    }
                    ...
                    if(count == 6){
                        ...
                        if( my_ans2.equals("") || my_ans2.equals("null") ){
                            Toast.makeText(getApplicationContext(), "یکی از گزینه ها را برای سوال دوم انتخاب کنید", Toast.LENGTH_SHORT).show();
                        }else{
                            have_answer++;
                        }
                    }
                    ...
                    if(count == 9){
                        ...
                        if( my_ans3.equals("") || my_ans3.equals("null") ){
                            Toast.makeText(getApplicationContext(), "یکی از گزینه ها را برای سوال سوم انتخاب کنید", Toast.LENGTH_SHORT).show();
                        }else{
                            have_answer++;
                        }
                    }
