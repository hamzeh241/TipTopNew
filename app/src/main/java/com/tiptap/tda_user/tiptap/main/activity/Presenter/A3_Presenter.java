...
public class A3_Presenter
        implements MVP_A3.ProvidedPresenterOps, MVP_A3.RequiredPresenterOps {

    private WeakReference<MVP_A3.RequiredViewOps> mView;
    private MVP_A3.ProvidedModelOps mModel;

    public A3_Presenter(MVP_A3.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A3.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A3.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A3.ProvidedModelOps model) {
        mModel = model;
    }
