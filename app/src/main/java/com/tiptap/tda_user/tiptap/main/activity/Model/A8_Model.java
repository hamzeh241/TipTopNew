...
public class A8_Model implements MVP_A8.ProvidedModelOps {

    private MVP_A8.RequiredPresenterOps mPresenter;
    DBAdapter dbAdapter;
    Context context;
    ...
    public A8_Model(MVP_A8.RequiredPresenterOps presenter, Context _conContext) {
