...
public class A28_Presenter
        implements MVP_A28.ProvidedPresenterOps, MVP_A28.RequiredPresenterOps {

    private WeakReference<MVP_A28.RequiredViewOps> mView;
    private MVP_A28.ProvidedModelOps mModel;

    public A28_Presenter(MVP_A28.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A28.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A28.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A28.ProvidedModelOps model) {
        mModel = model;
    }
