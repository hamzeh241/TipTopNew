...
public class A34_Presenter
             implements MVP_A34.ProvidedPresenterOps, MVP_A34.RequiredPresenterOps {

    private WeakReference<MVP_A34.RequiredViewOps> mView;
    private MVP_A34.ProvidedModelOps mModel;

    public A34_Presenter(MVP_A34.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A34.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A34.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A34.ProvidedModelOps model) {
        mModel = model;
    }
