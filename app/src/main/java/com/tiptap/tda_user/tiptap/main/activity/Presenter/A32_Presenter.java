...
public class A32_Presenter
        implements MVP_A32.ProvidedPresenterOps, MVP_A32.RequiredPresenterOps {

    private WeakReference<MVP_A32.RequiredViewOps> mView;
    private MVP_A32.ProvidedModelOps mModel;

    public A32_Presenter(MVP_A32.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A32.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A32.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A32.ProvidedModelOps model) {
        mModel = model;
    }
