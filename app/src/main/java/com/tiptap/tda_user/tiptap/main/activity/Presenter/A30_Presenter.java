...
public class A30_Presenter implements MVP_A30.ProvidedPresenterOps, MVP_A30.RequiredPresenterOps {

    private WeakReference<MVP_A30.RequiredViewOps> mView;
    private MVP_A30.ProvidedModelOps mModel;

    public A30_Presenter(MVP_A30.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A30.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A30.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A30.ProvidedModelOps model) {
        mModel = model;
    }
