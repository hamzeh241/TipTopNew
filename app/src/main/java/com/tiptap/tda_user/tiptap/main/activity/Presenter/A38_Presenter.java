...
public class A38_Presenter
        implements MVP_A38.ProvidedPresenterOps, MVP_A38.RequiredPresenterOps {

    private WeakReference<MVP_A38.RequiredViewOps> mView;
    private MVP_A38.ProvidedModelOps mModel;

    public A38_Presenter(MVP_A38.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A38.RequiredViewOps getView() throws NullPointerException{
        if ( mView != null )
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A38.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A38.ProvidedModelOps model) {
        mModel = model;
    }
