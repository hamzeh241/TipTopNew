...
public class A42 extends BaseActivity
    ...
    private static final String TAG = A42.class.getSimpleName();
    private final StateMaintainer mStateMaintainer = new StateMaintainer( getFragmentManager(), A42.class.getName());
    ...
    private void after_setup() {
        ...
        switch (lang_id){
            // فارسی
            case 1:
                t2.setText(R.string.A42_FA);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // کردی
            case 2:
                t2.setText(R.string.A42_KU);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // ترکی آذری
            case 3:
                t2.setText(R.string.A42_TA);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
            // چینی
            case 4:
                t2.setText(R.string.A42_CH);
                t2.setTextColor(getResources().getColor(R.color.my_black));
                break;
        }
        ...
        for(int i=0 ; i<count ; i++) {
            ...
            if(total == 1){
                ...
                // only text without ...
                    ...
                    t[id_t].setLayoutParams(params_txt);
    ...
    private void setupComponent(){
        ...
        SampleApp.get(this)
                .getAppComponent()
                .getA42Component(new Main_Module(this))
                .inject(this);
    }
    ...
    public void update_server(int idL) {
        try {
            ...
            new Post_UpdateUser(getApplicationContext(), A42.this, haveNetworkConnection(), UserName, idL).post();
