...
public class A46_Presenter
        implements MVP_A46.ProvidedPresenterOps, MVP_A46.RequiredPresenterOps {

    private WeakReference<MVP_A46.RequiredViewOps> mView;
    private MVP_A46.ProvidedModelOps mModel;

    public A46_Presenter(MVP_A46.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A46.RequiredViewOps getView() throws NullPointerException {
        if (mView != null)
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A46.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A46.ProvidedModelOps model) {
        mModel = model;
    }
