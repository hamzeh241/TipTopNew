...
public class A22_Presenter
        implements MVP_A22.ProvidedPresenterOps, MVP_A22.RequiredPresenterOps {

    private WeakReference<MVP_A22.RequiredViewOps> mView;
    private MVP_A22.ProvidedModelOps mModel;

    public A22_Presenter(MVP_A22.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    private MVP_A22.RequiredViewOps getView() throws NullPointerException {
        if (mView != null)
            return mView.get();
        else
    ...
    @Override
    public void setView(MVP_A22.RequiredViewOps view) {
        mView = new WeakReference<>(view);
    }

    public void setModel(MVP_A22.ProvidedModelOps model) {
        mModel = model;
    }
